          ...
          <div className='min-h-screen bg-slate-950 py-6 md:py-12'>
            <div className='mx-auto max-w-4xl space-y-6 px-3 sm:px-4 md:space-y-8'>
              <div className='flex items-center justify-between'>
                ...
                >
                  <div className='flex items-center gap-2 rounded-lg border border-slate-800 bg-slate-900 px-3 py-2 group-hover:border-slate-700'>
                ...
                <div className='flex items-center gap-2 rounded-full border border-emerald-500/20 bg-emerald-500/10 px-3 py-1.5 text-emerald-400'>
              ...
              <div className='flex flex-col justify-between gap-4 md:flex-row md:items-end'>
                <div className='text-center md:text-left'>
                  <h1 className='bg-linear-to-r from-sky-400 to-purple-400 bg-clip-text text-2xl font-bold text-transparent sm:text-3xl md:text-4xl'>
                ...
                <div className='flex items-center justify-center gap-2 sm:gap-3 md:justify-end'>
                  <button
                    onClick={() =>
                      dispatch(updateContestThunk({ id: '1', data: data }))
                    }
                    className='flex items-center gap-1 rounded-xl border border-slate-800 bg-slate-900 px-4 py-2 text-sm font-bold text-slate-300 transition-all hover:bg-slate-800 hover:text-white active:scale-95 sm:gap-2 sm:rounded-2xl sm:px-6 sm:py-3 sm:text-base'
                  >
                    <Save size={16} className='sm:h-4.5 sm:w-4.5' />
                    <span>Сохранить</span>
                  </button>
                  <button className='flex items-center gap-1 rounded-xl bg-sky-600 px-4 py-2 text-sm font-bold text-white shadow-lg shadow-sky-600/20 transition-all hover:bg-sky-500 active:scale-95 sm:gap-2 sm:rounded-2xl sm:px-6 sm:py-3 sm:text-base'>
                    <Save size={16} className='sm:h-4.5 sm:w-4.5' />
              ...
              <div className='space-y-6 rounded-2xl border border-slate-800 bg-slate-900/50 p-4 backdrop-blur-sm sm:rounded-3xl sm:p-6 md:space-y-8 md:p-8'>
                ...
                <section className='border-t border-slate-800/50 pt-6'>
                  <div className='flex flex-col items-center justify-between gap-4 rounded-2xl border border-red-500/10 bg-red-500/5 p-4 sm:flex-row sm:p-6'>
                    <div className='text-center sm:text-left'>
                      <h3 className='text-sm font-bold tracking-wider text-red-400 uppercase'>
                        Danger zone
                      </h3>
                    ...
                    <button
                      ...
                      className='rounded-xl border border-red-500/20 bg-red-500/10 px-4 py-2 text-xs font-bold text-red-400 transition-all hover:bg-red-950 hover:text-white active:scale-95'
                    >
                      Удалить мероприятие
                    </button>
                  </div>
