...
const StatCard = ({ value, label, className = ''}:StatCardProps) => {
  ...
  return (
    ...
    <div className={`group relative px-6 py-6 border-2 border-sky-600/50 rounded-2xl 
                    bg-linear-to-br from-gray-900 to-gray-800
                    hover:border-sky-500 hover:scale-105 hover:shadow-2xl hover:shadow-sky-500/20
                    transform transition-all duration-1000 ease-out
                    overflow-hidden ${className}`}>
      <div className="absolute inset-0 bg-linear-to-r from-sky-600/0 via-sky-600/10 to-sky-600/0 
